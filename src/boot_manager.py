...
class bootManager():
    ...
    def __init__(self):
        ...
        bbox1 = Gtk.VBox()
        bbox1.show()
        self.refind = Gtk.RadioButton()
        self.redind.new_with_label_from_widget(None,
        ...
        self.bsd = Gtk.RadioButton()
        self.bsd.new_with_label_from_widget(self.refind,
        ...
        self.none = Gtk.RadioButton()
        self.none.new_with_label_from_widget(self.bsd,

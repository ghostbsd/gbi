...
data_files = [
    ...
    ('{prefix}/lib/gbi'.format(prefix=sys.prefix), ['src/dekstopbsd-style.css']),
    ...
    ('{prefix}/lib/gbi/slide-images/ghostbsd'.format(prefix=sys.prefix), ['src/slide-images/desktopbsd/D-logo.png']),
    ('{prefix}/lib/gbi/slide-images/ghostbsd'.format(prefix=sys.prefix), ['src/slide-images/desktopbsd/browser.png']),
    ('{prefix}/lib/gbi/slide-images/ghostbsd'.format(prefix=sys.prefix), ['src/slide-images/desktopbsd/customize.png']),
    ('{prefix}/lib/gbi/slide-images/ghostbsd'.format(prefix=sys.prefix), ['src/slide-images/desktopbsd/email.png']),
    ('{prefix}/lib/gbi/slide-images/ghostbsd'.format(prefix=sys.prefix), ['src/slide-images/desktopbsd/help.png']),
    ('{prefix}/lib/gbi/slide-images/ghostbsd'.format(prefix=sys.prefix), ['src/slide-images/desktopbsd/music.png']),
    ('{prefix}/lib/gbi/slide-images/ghostbsd'.format(prefix=sys.prefix), ['src/slide-images/desktopbsd/office.png']),
    ('{prefix}/lib/gbi/slide-images/ghostbsd'.format(prefix=sys.prefix), ['src/slide-images/desktopbsd/photos.png']),
    ('{prefix}/lib/gbi/slide-images/ghostbsd'.format(prefix=sys.prefix), ['src/slide-images/desktopbsd/social.png']),
    ('{prefix}/lib/gbi/slide-images/ghostbsd'.format(prefix=sys.prefix), ['src/slide-images/desktopbsd/software.png']),
    ('{prefix}/lib/gbi/slide-images/ghostbsd'.format(prefix=sys.prefix), ['src/slide-images/desktopbsd/videos.png']),
    ('{prefix}/lib/gbi/slide-images/ghostbsd'.format(prefix=sys.prefix), ['src/slide-images/desktopbsd/welcome.png']),

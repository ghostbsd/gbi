...
data_files = [
    ...
    ('{prefix}/lib/gbi/slide-images'.format(prefix=sys.prefix), ['src/slide-images/Exaile.png',]),
    ('{prefix}/lib/gbi/slide-images'.format(prefix=sys.prefix), ['src/slide-images/G-logo.png',]),
    ('{prefix}/lib/gbi/slide-images'.format(prefix=sys.prefix), ['src/slide-images/Mozilla-Firefox-Start-Page.png',]),
    ('{prefix}/lib/gbi/slide-images'.format(prefix=sys.prefix), ['src/slide-images/Shotwell.png',]),
